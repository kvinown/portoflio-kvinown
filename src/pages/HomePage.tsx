...
import { Mail, Phone, MapPin, Globe, Server, Layout as LayoutIcon, Smartphone, Database, Wrench, ChevronRight, Send, Briefcase, Users, Download, User } from "lucide-react";

// Import komponen pembantu
import { FadeInSection } from "../components/FadeInSection";
import { TechDivider } from "../components/TechDivider";
import { GithubIcon, LinkedinIcon, InstagramIcon } from "../components/Icons";

export const HomePage = ({ t, c, theme, portofolioData }: any) => {
	// Pindahkan logika form ke komponen halamannya sendiri
	...
	return (
		<>
			...
			{/* SISA KONTEN (Skills, Experience, Projects, Education, Contact) */}
